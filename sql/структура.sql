...
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown, image_link)
    values (1, '«Капитанская дочка» — короткий исторический роман (или повесть) А. С. Пушкина, действие которого происходит во время восстания Емельяна Пугачёва. Впервые опубликован без указания имени автора в 4-й книжке журнала «Современник», поступившей в продажу в последней декаде 1836 года.', 'Капитанская дочка', 'Капитанская дочка.txt', 0, to_date('1836', 'YYYY'), 1, 1, 'pushkin/captain_daughter.jpg');
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (2, '«Руслан и Людмила» — первая законченная поэма Александра Сергеевича Пушкина; волшебная сказка, вдохновлённая древнерусскими былинами.', 'Руслан и Людмила', 'Руслан и Людмила.txt', 0, to_date('1820', 'YYYY'), 2, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (3, '«Непобедимый» (польск. Niezwyciężony) — научно-фантастический роман Станислава Лема 1964 года.', 'Непобедимый', 'si-fi/Непобедимый.txt', 0, to_date('1964', 'YYYY'), 3, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (4, '«Двена́дцать сту́льев» — роман И. Ильфа и Е. Петрова. Написан в 1927 году. Жанр — остросатирический роман-фельетон.', 'Двенадцать стульев', 'Двенадцать стульев.txt', 0, to_date('1928', 'YYYY'), 4, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (5, '«Автостопом по галактике» (англ. The Hitchhiker’s Guide to the Galaxy или дословно «Путеводитель по галактике для автостопщиков», «Путеводитель для путешествующих по галактике автостопом», 1979) — юмористический фантастический роман английского писателя Дугласа Адамса. Первая книга одноимённой серии.', 'Автостопом по галактике', 'si-fi/Дуглас Адамс - Автостопом по Галактике. Ресторан «У конца Вселенной».epub', 0, to_date('1979', 'YYYY'), 3, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (6, '«Винни-Пух» представляет собой дилогию, но каждая из двух книг Милна распадается на 10 рассказов (stories) с собственным сюжетом.', 'Винни-Пух', 'fairytale/Винни-Пух.txt', 0, to_date('1928', 'YYYY'), 5, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (7, '«Сказка о царе Салтане, о сыне его славном и могучем богатыре князе Гвидоне Салтановиче и о прекрасной царевне Лебеди» (укороченный вариант названия — «Сказка о царе Салтане») — сказка в стихах А. С. Пушкина. Создана в 1831 году, впервые издана в 1832 году.', 'Сказка о царе Салтане', 'fairytale/Сказка о царе Салтане.txt', 0, to_date('1832', 'YYYY'), 5, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (8, '«Ска́зка о рыбаке́ и ры́бке» — сказка Александра Сергеевича Пушкина. Написана 14 октября 1833 года. Впервые напечатана в 1835 году в журнале «Библиотека для чтения»', 'Сказка о рыбаке и рыбке', 'fairytale/Сказка о рыбаке и рыбке.txt', 0, to_date('1835', 'YYYY'), 5, 1);
insert into books(book_id, description, title, link, cost, release_date, category_id, is_shown)
    values (9, '«Сказка о попе и о работнике его Балде» — сказка А. С. Пушкина. При жизни поэта не печаталась. Написана в Болдине 13 сентября 1830 года. Основой послужила русская народная сказка, записанная Пушкиным в Михайловском.', 'Сказка о попе и о работнике его Балде', 'fairytale/Сказка о попе и о работнике его Балде.txt', 0, to_date('1830', 'YYYY'), 5, 1);
